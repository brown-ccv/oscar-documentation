...
* If a cell is blank, that module will be installed later
* If a cell says (system RPM), that software is installed on the nodes. Users don't need to load this module.&#x20;
* If a module is listed here, users can load this module using the command `module load <name>`
...
| curl                  | curl/8.0.1                                             |
| cutadapt              | py-cutadapt/4.1                                        |
| dada2                 |                                                        |
| datamash              | datamash/1.8                                           |
| dcm2bids              | py-dcm2bids                                            |
